...
(cl:in-package pkg_techfest_imc-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <dest>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'dest)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pkg_techfest_imc-msg:<dest> is deprecated: use pkg_techfest_imc-msg:dest instead.")))

(cl:ensure-generic-function 'dest_x_coordinate-val :lambda-list '(m))
(cl:defmethod dest_x_coordinate-val ((m <dest>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_techfest_imc-msg:dest_x_coordinate-val is deprecated.  Use pkg_techfest_imc-msg:dest_x_coordinate instead.")
  (dest_x_coordinate m))

(cl:ensure-generic-function 'dest_y_coordinate-val :lambda-list '(m))
(cl:defmethod dest_y_coordinate-val ((m <dest>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_techfest_imc-msg:dest_y_coordinate-val is deprecated.  Use pkg_techfest_imc-msg:dest_y_coordinate instead.")
  (dest_y_coordinate m))
